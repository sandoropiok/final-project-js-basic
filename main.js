  ...
  prompt
    ...
    .then((answer) => {
      if (answer === "  ＦＩＲＳＴ ＬＯＣＫ") {
        console.log(
          chalk.yellowBright(
            `\n    ＹＯＵ ＣＨＯＯＳＥ ＦＩＲＳＴ ＬＯＣＫ ＡＮＤ ＰＲＯＣＥＥＤ ＴＯ ＷＯＲＤ ＳＣＲＡＭＢＬＥ ＧＡＭＥ！`
          )
        );
        const scrambleSuccess = playWordScrambleGame();
        if (scrambleSuccess) {
          console.log(
            chalk.greenBright(`
            ╔═╗╔═╗╔╗╔╔═╗╦═╗╔═╗╔╦╗╔═╗┬
            ║  ║ ║║║║║ ╦╠╦╝╠═╣ ║ ╚═╗│
            ╚═╝╚═╝╝╚╝╚═╝╩╚═╩ ╩ ╩ ╚═╝o
        YOU PASSED THE WORD SCRAMBLE GAME. MOVING TO SECOND LOCK...`)
          );
          const riddleSuccess = playLastRiddleGame();
          if (riddleSuccess) {
            console.log(
              chalk.green(`     
  ██▒   █▓ ██▓ ▄████▄  ▄▄▄█████▓ ▒█████   ██▀███ ▓██   ██▓    ██▓  ██████    ▓██   ██▓ ▒█████   █    ██  ██▀███    ██████  ▐██▌ 
  ...
  ▓██  █▒░▒██▒▒▓█    ▄ ▒ ▓██░ ▒░▒██░  ██▒▓██ ░▄█ ▒ ▒██ ██░   ▒██▒░ ▓██▄        ▒██ ██░▒██░  ██▒▓██  ▒██░▓██ ░▄█ ▒░ ▓██▄    ▐██▌ 
   ▒██ █░░░██░▒▓▓▄ ▄██▒░ ▓██▓ ░ ▒██   ██░▒██▀▀█▄   ░ ▐██▓░   ░██░  ▒   ██▒     ░ ▐██▓░▒██   ██░▓▓█  ░██░▒██▀▀█▄    ▒   ██▒ ▓██▒ 
    ...
    ┗┛┗┛┗┻ ┗┛┗   ┗┻┗ ┛┗ ┗┻┗┗ ┗┻  ┗┛┗┗   ┗┻┗┻┛ ┛┗┛┗┗ ┛┛╻  ┗┻┛┗┗┗┛┗┛┗┗ ┗┻  ┗┛┗┗   ┛┗┛┗┗┻┗  ┗┻┗┛┗┛┛ ╻  ┗┻┛┗┗┻  ┣┛┛ ┗┛┗┛┗ ┛┗ 
        ...
        console.log(
          chalk.yellowBright(
            `\n    ＹＯＵ ＣＨＯＯＳＥ ＳＥＣＯＮＤ ＬＯＣＫ ＡＮＤ ＰＲＯＣＥＥＤ ＴＯ ＲＩＤＤＬＥ ＧＡＭＥ！`
          )
        );
        const riddleSuccess = playLastRiddleGame();
        if (riddleSuccess) {
          console.log(
            ...
            ║  ║ ║║║║║ ╦╠╦╝╠═╣ ║ ╚═╗│
            ╚═╝╚═╝╝╚╝╚═╝╩╚═╩ ╩ ╩ ╚═╝o
        YOU PASSED THE WORD SCRAMBLE GAME. MOVING TO FIRST LOCK...`)
          );
